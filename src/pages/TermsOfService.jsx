                ...
                <div className="container mx-auto max-w-4xl relative">
                    ...
                    <div className="prose prose-invert prose-lg max-w-none prose-headings:font-wide prose-headings:uppercase prose-headings:tracking-tight prose-p:font-sans prose-p:text-gray-300 prose-p:leading-relaxed">
                        <p className="lead text-2xl font-light text-white leading-relaxed mb-12">
                            Welcome to BADDIE CONSULTING. These Terms of Service govern your access to and use of our website and services. By accessing or using our services, you agree to be bound by these Terms.
                        </p>

                        <h2 className="text-3xl text-white font-bold mb-6">1. Services</h2>
                        <p>BADDIE CONSULTING provides AI-powered marketing content creation services, including product photography, video marketing, and social media content. You acknowledge that our services utilize artificial intelligence tools to create visual content.</p>
                        ...
                        <p>To the maximum extent permitted by law, BADDIE CONSULTING shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues.</p>
                        ...
                        <ul className="list-none space-y-2 mb-8 font-mono text-sm bg-white/5 p-6 rounded-lg border border-white/10">
                            <li><strong>Email:</strong> legal@baddieconsulting.com</li>
